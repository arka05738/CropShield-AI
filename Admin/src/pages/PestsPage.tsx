...
export function PestsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Pests"
        description="Aggregated pest detections from GET /api/v1/admin/pests"
      ...
      <div className="panel overflow-hidden rounded-xl">
        ...
        {!loading && !error && items.length === 0 ? (
          <EmptyState
            ...
            detail="Pest rows appear when analyses include pest detections."
          />
        ) : null}
        {!loading && !error && items.length > 0 ? (
